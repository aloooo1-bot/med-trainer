...
function selectHpi(c: CaseData, difficulty: string): string {
...
// Returns 'high' | 'low' | null by comparing a numeric value against a reference range string.
// Handles formats: "4.5-11.0", "< 100", "> 10", "≤ 5.0", "0-100"
...
function ECGPanel({ ecgFindings, aiReport, image, diagnosisSubmitted, onZoom }: {
  ecgFindings?: string
  aiReport: string
...
function ImagingPanel({ report, results, diagnosisSubmitted }: {
  report: string
